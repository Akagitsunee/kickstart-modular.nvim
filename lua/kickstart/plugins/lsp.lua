...
return {
  -- LSP Configuration 
    -- LSP Configuration
    {
      ...
      config = function()
        -- Setup Mason first (this is lightweight)
        ...
        -- Defer the heavy LSP setup
        vim.schedule(function()
          require('kickstart.plugins.lsp.setup')
          require('kickstart.plugins.lsp.config')
          require('kickstart.plugins.lsp.functions')
        end)
      end
    },
  
    -- Mason LSP Config - separate for better control
    {
      "williamboman/mason-lspconfig.nvim",
      event = { "BufReadPre", "BufNewFile" },
      dependencies = { "williamboman/mason.nvim" },
      config = function()
        -- Use vim.schedule to defer this as well
        vim.schedule(function()
    ...
    -- TypeScript Tools - separate lazy loading
    {
      "pmizio/typescript-tools.nvim",
      ...
      config = function()
        ...
        require("typescript-tools").setup({
          ...
          handlers = require("kickstart.plugins.lsp.servers.tsserver").handlers,
          on_attach = require("kickstart.plugins.lsp.servers.tsserver").on_attach,
          settings = require("kickstart.plugins.lsp.servers.tsserver").settings,
        })
      end,
    },
